...
namespace Orbit.Api.Client
{
        ...
        public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Orbit.Api.Client.Configuration.Default;
            RestClient = new RestClient("https://app.orbit.love/api/v1");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://app.orbit.love/api/v1).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Orbit.Api.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://app.orbit.love/api/v1")
        {
